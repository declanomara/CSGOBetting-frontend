                ...
                <>
                    {betPlaced ? (
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                            ...
                            <button style={{ color: '#f44336', backgroundColor: 'transparent', border: '1px solid #f44336', padding: '10px', borderRadius: '5px', width: '100%', margin: "2px", transform: 'translateY(0)', transition: 'transform 0.2s' }} onClick={handleCancelBet} onMouseDown={e => e.target.style.transform = 'translateY(2px)'} onMouseUp={e => e.target.style.transform = 'translateY(0)'}>Cancel Bet</button>
                        </div>
                    ) : (
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                            ...
                            <button style={{ color: '#de9b35', backgroundColor: 'transparent', border: '1px solid #de9b35', padding: '10px', borderRadius: '5px', width: '100%', margin: "2px", transform: 'translateY(0)', transition: 'transform 0.2s' }} onClick={() => handlePlaceBet(1)} onMouseDown={e => e.target.style.transform = 'translateY(2px)'} onMouseUp={e => e.target.style.transform = 'translateY(0)'}>Bet on {match.competitors[0]}</button>
                            <button style={{ color: '#5d79ae', backgroundColor: 'transparent', border: '1px solid #5d79ae', padding: '10px', borderRadius: '5px', width: '100%', margin: "2px", transform: 'translateY(0)', transition: 'transform 0.2s' }} onClick={() => handlePlaceBet(2)} onMouseDown={e => e.target.style.transform = 'translateY(2px)'} onMouseUp={e => e.target.style.transform = 'translateY(0)'}>Bet on {match.competitors[1]}</button>
                        </div>
                    )}
                </>
            )}
